...
<head>
  ...
  <title>CMS Editor 5.0 | Miguel Madrigal</title>
  <style>
...
<body>
  ...
  <div class="editor-topbar">
    <div class="editor-title">Editor 5.0: Multi-Drag</div>
  ...
  <script>
    ...
    const sortableConfig = { 
      ...
      selectedClass: 'sortable-selected', // The class applied to selected items
      fallbackTolerance: 3, 
...
console.log('Successfully built Visual Editor 5.0 with MultiDrag');
